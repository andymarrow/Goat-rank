        ...
        {liveBattles.map((battle) => {
          ...
          return (
            <Link href={`/battle/${battle.id}`} key={battle.id} className="pressable hover-lift snap-start shrink-0 group">
              <div className="corner-ticks relative w-[240px] md:w-[280px] h-[360px] md:h-[420px] cut-corner bg-card border border-border group-hover:border-primary/50 transition-all overflow-hidden flex flex-col">
                ...
                <div className="relative flex-1 w-full bg-[#111]">
                  ...
                  <span
                    className="absolute bottom-4 left-4 font-arcade text-base md:text-lg font-bold z-10 max-w-[80%] truncate"
                    style={{
                      color: readableBrand(c1.brand_color, true),
                ...
                <div className="relative flex-1 w-full bg-[#111]">
                  ...
                  <span
                    className="absolute top-4 right-4 font-arcade text-base md:text-lg font-bold z-10 text-right max-w-[80%] truncate"
                    style={{
                      color: readableBrand(c2.brand_color, true),
                      textShadow: "0 2px 10px rgba(0,0,0,0.95)",
                    }}
                  >
                    {c2.name}
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-4 flex justify-between items-end z-10">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-white/70 font-arcade" style={{ textShadow: "0 1px 6px rgba(0,0,0,0.9)" }}>POOL</span>
